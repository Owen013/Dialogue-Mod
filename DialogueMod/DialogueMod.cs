...
{
    public class DialogueMod : ModBehaviour
    {
        public static DialogueMod Instance;
        ...
        private void Start()
        {
            ...
            ModHelper.Console.WriteLine($"{nameof(DialogueMod)} is ready to go!", MessageType.Success);
        }
    }
    ...
    public static class Patches
    {
        public static void AchievementEarned(Achievements.Type type)
        {
            ...
            {
                name = "_";
                DialogueMod.Instance.ModHelper.Console.WriteLine($"FOUND_SIGNAL");
            }
            else if (type == Achievements.Type.TOTAL)
            {
                name = "_";
                DialogueMod.Instance.ModHelper.Console.WriteLine($"TOTAL");
            }
            if (name == "_") return;
            DialogueMod.Instance.ModHelper.Console.WriteLine($"Achievement \"{name}\" earned!", MessageType.Success);
        }
    }
}
